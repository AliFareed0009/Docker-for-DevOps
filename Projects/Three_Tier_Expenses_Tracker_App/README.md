...
6. **To run this in Containers**
docker compose up --build

7. **To run this with Docker File**
docker build -t .

8. **See what is the name of the image**
docker images

9. **Now run the command below and check write localhost:8080 on your web browser**
